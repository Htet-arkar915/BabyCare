package com.example.dell.babycare.Activities.developmentActivities.taunggyiClinic;
...
public class T_Clinic1 extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_t__clinic1);
        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.t_clinic1);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng clinic8=new LatLng(20.776366,97.039140);
        MarkerOptions markerOptions7=new MarkerOptions();
        markerOptions7.position(clinic8);
        markerOptions7.title("မိခင္နွွင္႔ကေလးေဆးရုံ");
