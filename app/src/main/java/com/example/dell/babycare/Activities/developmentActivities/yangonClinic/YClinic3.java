...
public class YClinic3 extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yclini3);
        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.y_clinic3);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng clinic8=new LatLng(16.877317,96.129865);
        MarkerOptions markerOptions7=new MarkerOptions();
        markerOptions7.position(clinic8);
        markerOptions7.title("၀ိတိုရိယေဆးရံုႀကီး");
