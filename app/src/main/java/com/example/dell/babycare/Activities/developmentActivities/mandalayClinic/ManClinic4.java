...
public class ManClinic4  extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_man_clinic4);
        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.man_map4);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng clinic4=new LatLng(21.980658,96.096602);
        MarkerOptions markerOptions3=new MarkerOptions();
        markerOptions3.position(clinic4);
        markerOptions3.title("ခ်မ္းၿငိမ္းေအာင္(မႏၱေလး)");
        ...
        polyline.add(here, clinic4);
        mMap.addPolyline(polyline);

        LatLng haftWay = new LatLng((here.latitude + clinic4.latitude)/2 , (here.longitude + clinic4.longitude)/2 );
