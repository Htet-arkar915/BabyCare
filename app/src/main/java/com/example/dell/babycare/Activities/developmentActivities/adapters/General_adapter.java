...
public class General_adapter extends RecyclerView.Adapter<General_adapter.MyHolder>{ Context context;
    ArrayList<Question_Model> question_list=new ArrayList<>();
    public General_adapter(Context about_mother, ArrayList<Question_Model> question_list) {
        this.context=about_mother;
        this.question_list=question_list;
    }

    @Override
    public General_adapter.MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(context).inflate(R.layout.general_recycler,parent,false);
        MyHolder h=new MyHolder(v);
        return h;
    }

    @Override
    public void onBindViewHolder(General_adapter.MyHolder holder, final int position) {
    ...
    public class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(View itemView) {
            super(itemView);
            textView= (TextView) itemView.findViewById(R.id.general_recycler_question);
        }
    }
}
