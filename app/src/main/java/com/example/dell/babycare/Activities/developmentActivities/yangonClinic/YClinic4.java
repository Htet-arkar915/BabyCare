...
public class YClinic4 extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yclinic4);
        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.y_clinic4);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng clinic8=new LatLng(16.849627,96.156158);
        MarkerOptions markerOptions7=new MarkerOptions();
        markerOptions7.position(clinic8);
        markerOptions7.title("ပါရမီအေထြေထြေရာဂါကုေဆးရံု");
