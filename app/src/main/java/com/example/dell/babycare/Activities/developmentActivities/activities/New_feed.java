...
public class New_feed extends AppCompatActivity implements View.OnClickListener {
RecyclerView recyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addpostFloating= (FloatingActionButton) findViewById(R.id.addpost);
        addpostFloating.setOnClickListener(this);
        pbar= (ProgressBar) findViewById(R.id.new_progress);
        postData=new ArrayList<DevelopmentModel>();
        recyclerView= (RecyclerView) findViewById(R.id.post_recycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(New_feed.this));
        Firebase.setAndroidContext(New_feed.this);
    ...
    private void getCommentCount(DataSnapshot dataSnapshot) {
        ...
        adapter = new NewAdapter(New_feed.this, postData, isLike,real_comment_count_list);
    ...
    public void onClick(View view) {
        Intent goo=new Intent(New_feed.this,Post_activity.class);
        startActivity(goo);
    }
}
