...
public class ManClinic6 extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_man_clinic6);
        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.man_map6);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng clinic6=new LatLng(21.967703,96.092207);
        MarkerOptions markerOptions6=new MarkerOptions();
        markerOptions6.position(clinic6);
        markerOptions6.title("ေအးသုခ(မႏၱေလး)");
