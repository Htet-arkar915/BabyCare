...
///https://myschoolserver-dcae9.firebaseio.com/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baby_shop_development);
        Firebase.setAndroidContext(BabyDevelopmentActivity.this);
        getImage= (Button) findViewById(R.id.getImage);
        ok= (Button) findViewById(R.id.ok);
        name= (EditText) findViewById(R.id.fshop_name);
        address= (EditText) findViewById(R.id.fshop_address);
        ph_no= (EditText) findViewById(R.id.fshop_phno);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.ok:
                ...
                dm.setShopImage(fromStorageUri);
                dm.setShop_name(name.getText().toString());
                dm.setShop_address(address.getText().toString());
                dm.setShop_phno(ph_no.getText().toString());
                firebase.child("ShopImage").push().setValue(dm);
                break;
        }
    }
