package com.example.dell.babycare.Activities.developmentActivities.yangonClinic;
...
public class YClinic1 extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.dell.babycare.R.layout.activity_yclinic1);
        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(com.example.dell.babycare.R.id.y_clinic1);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng clinic8=new LatLng(16.788076,96.136147);
        MarkerOptions markerOptions7=new MarkerOptions();
        markerOptions7.position(clinic8);
        markerOptions7.title("ရန္ကုန္ကေလးေဆးရံုႀကီး");
