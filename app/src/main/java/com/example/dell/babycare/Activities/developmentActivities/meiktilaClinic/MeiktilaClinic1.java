package com.example.dell.babycare.Activities.developmentActivities.meiktilaClinic;
...
public class MeiktilaClinic1 extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.man_map1);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng clinic8=new LatLng(20.876143,95.860506);
        MarkerOptions markerOptions7=new MarkerOptions();
        markerOptions7.position(clinic8);
        markerOptions7.title("ေဒါက္တာ ခင္ျမင္႔သန္း(မိတၳီလာ) ");
