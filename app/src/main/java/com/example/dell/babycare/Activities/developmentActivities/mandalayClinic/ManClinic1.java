...
public class ManClinic1 extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manclinic);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng clinic1 = new LatLng(21.979925, 96.114756);
        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(clinic1);
        markerOptions.title("ေဒါက္တာ ေမာင္ေမာင္ႀကီးေဆးခန္း(မႏၱေလး)");
