...
public class NClinic3 extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.dell.babycare.R.layout.activity_nclinic3);
        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(com.example.dell.babycare.R.id.nay_clinic3);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng clinic1 = new LatLng(19.787255, 96.118990);
        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(clinic1);
        markerOptions.title("ေဘာဂသိဒၶိေဆးရံု");
