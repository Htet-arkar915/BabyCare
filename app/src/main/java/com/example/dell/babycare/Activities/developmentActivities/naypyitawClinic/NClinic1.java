...
public class NClinic1 extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.dell.babycare.R.layout.activity_nclinic1);
        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(com.example.dell.babycare.R.id.nay_clinic1);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng here = new LatLng(LocationDetails.latitude, LocationDetails.longtitude);
        mMap.addMarker(new MarkerOptions().position(here).title("Your location is here"));//
        //mMap.moveCamera(CameraUpdateFactory.newLatLng(here));


        LatLng clinic1 = new LatLng(19.919229, 96.263100);
        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(clinic1);
        markerOptions.title("တပ္မေတာ္၊ သားဖြား၊ မီးယပ္နွင္႔ ကေလးေဆးရံု");
