...
import com.example.dell.babycare.Activities.developmentActivities.adapters.Characteristics_adapter;
...
public class Characteristics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView= (RecyclerView) findViewById(R.id.characteristics_recycler);
        toolbar= (Toolbar) findViewById(R.id.characteristics_toolbar);

        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle(R.string.question_characteristics_title);
        ...
        try {
            ...
            adapter=new Characteristics_adapter(Characteristics.this,question_list);
    ...
    private String LoadJSONFrom() {
        ...
        try {
            InputStream inputStream=getAssets().open("characteristics.json");
