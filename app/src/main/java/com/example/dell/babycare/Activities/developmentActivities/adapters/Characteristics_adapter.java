...
public class Characteristics_adapter extends RecyclerView.Adapter<Characteristics_adapter.MyHolder> {
    Context context;
    ArrayList<Question_Model> question_list=new ArrayList<>();
    public Characteristics_adapter(Context characteristics, ArrayList<Question_Model> question_list) {
        this.context=characteristics;
        this.question_list=question_list;
    }

    @Override
    public Characteristics_adapter.MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(context).inflate(R.layout.characteristics_recycler,parent,false);
        MyHolder h=new MyHolder(v);
        return h;
    }

    @Override
    public void onBindViewHolder(Characteristics_adapter.MyHolder holder, final int position) {
    ...
    public class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(View itemView) {
            super(itemView);
            textView= (TextView) itemView.findViewById(R.id.characteristics_recycler_question);
        }
    }
}
